...
namespace benewake
{
	...
	bool startMeasurement(int _sd, int _times = 0)
	{
	    clearSocketBuffer(_sd);
        if(_times == 0)
        {
            if(send_command(_sd, kStart, strlen(kStart)) < 0)
            {
