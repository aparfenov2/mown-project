...
class MainWindows(object):
    def __init__(self) -> None:
        ...
        self.button_point_task = Button(
            self.window,
            text="Task Navigate To Point",
            command=self.button_point_task_callback,
        )
        ...
        self.button_polygon_task = Button(
            self.window,
            text="Task Go Through Polygon",
            command=self.button_polygon_task_callback,
        )
        ...
        self.button_remove_all = Button(
            ...
            command=self.button_remove_all_callback,
        )
...
class TaskPointState(object):
    def __init__(self, main_window) -> None:
        ...
        self.viz_publisher = rospy.Publisher(
            "/debug/rviz/point", PointStamped, queue_size=2
        )
...
class TaskPolygonState(object):
    def __init__(self, main_window) -> None:
        ...
        self.pub2 = rospy.Publisher(
            rospy.get_param("/planner/topics/coverage_task"), CoverageTask, queue_size=2
        )
        self.viz_publisher = rospy.Publisher(
            "/debug/rviz/polygon", PolygonStamped, queue_size=2
        )
