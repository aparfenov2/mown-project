...
if __name__ == '__main__':
    ...
    mbf_mb_ac = actionlib.SimpleActionClient("DWA_node/move_base", mbf_msgs.MoveBaseAction)
    mbf_gp_ac = actionlib.SimpleActionClient("DWA_node/get_path", mbf_msgs.GetPathAction)
    ...
    mbf_drc = Client("DWA_node", timeout=10)
